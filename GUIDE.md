...
### Основные файлы
- `telegram_profile_bot.py` - основной файл бота
- `profiles.json` - файл с профилями пользователя
...
- `uninstall_service.bat` - удаление службы Windows
- `windows_service.py` - реализация службы Windows
